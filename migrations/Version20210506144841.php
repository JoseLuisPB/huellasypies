...
final class Version20210506144841 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE usuario (id INT AUTO_INCREMENT NOT NULL, rol_id INT NOT NULL, nombre VARCHAR(255) NOT NULL, poblacion VARCHAR(255) NOT NULL, provincia VARCHAR(255) NOT NULL, password VARCHAR(255) NOT NULL, activo TINYINT(1) NOT NULL, email VARCHAR(255) NOT NULL, telefono VARCHAR(255) NOT NULL, fecha_alta VARCHAR(255), reiniciar_password TINYINT(1) NOT NULL, direccion VARCHAR(255) DEFAULT NULL, INDEX IDX_2265B05D4BAB96C (rol_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
